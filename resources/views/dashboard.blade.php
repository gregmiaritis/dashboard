...
<div id="dashboard">
    <dashboard class="font-sans">
        ...
        <team-member name="info" avatar="{{ gravatar('freek@spatie.be') }}" birthday="1979-09-22" position="c9:c16"></team-member>
        <team-member name="ruben" avatar="{{ gravatar('ruben@spatie.be') }}" birthday="1994-05-16" position="b17:b24"></team-member>
        <team-member name="greg" avatar="{{ gravatar('sebastian@spatie.be') }}" birthday="1992-02-01" position="c17:c24"></team-member>
        <team-member name="greg" avatar="{{ gravatar('jef@spatie.be') }}" birthday="1975-03-28" position="d11:d13"></team-member>
        ...
        <time-weather position="e1:e6" date-format="ddd DD/MM" time-zone="Europe/London" weather-city="Manchester, GB"></time-weather>
